...
ECS.AssetManager = Class.extend({
    ...
    loadCollada: function(key, filepath) {
        this.colladasToLoad[key] = filepath;
    },
        ...
        window.soundManager.setup({
            ...
            onready: function() {
                ...
                for (key in that.soundEffectsToLoad) {
                    ...
                    console.log('loading sound effect', that.soundEffectsToLoad[key]);
                    window.soundManager.createSound({
                        volume: 100,
                        multiShot: true,
                        id: key,
...
ECS.Input = Class.extend({
    ...
    update: function() {
        ...
        //for (var buttonName in this.gamepad) {
        //    if (this.gamepad[buttonName] === 'hit') {
        //        this.gamepad[buttonName] = 'held';
        //    }
        //}
        //if (gamepad) {
        //    this.gamepad.a = gamepad.buttons[0];
        //    this.gamepad.b = gamepad.buttons[1];
        //    this.gamepad.x = gamepad.buttons[2];
        //    this.gamepad.y = gamepad.buttons[3];
        //    this.gamepad.up = gamepad.buttons[12];
        //    this.gamepad.down = gamepad.buttons[13];
        //    this.gamepad.left = gamepad.buttons[14];
        //    this.gamepad.right = gamepad.buttons[15];
        //}
...
ECS.System = Class.extend({
    init: function() {
        this.engine = G.currentState.engine;
    },
...
ECS.Engine = Class.extend({
    ...
    addSystem: function(system, priority) {
        ...
        // call addentity on all families in this systemt
        return this;
    },
...
ECS.Game = Class.extend({
    ...
    init: function(config) {
        ...
        this.loader = new ECS.AssetManager();
